	...
	var welcome = {
      ...
      stimulus: "You are now going to start a trial session for the experiment. Press any key to begin."
    };
	...
	var instructions = {
      type: "html-keyboard-response",
      stimulus: "<p>Numbers will appear in the center of the screen.</p>" +
				...
				"<br>" +
				"<p>Make sure the experiment is open in an active window, displayed in the center and you are using a computer.</p>"+
				"<p>Please, also ensure your keyboard is connected to the computer and that there are no distractions around you.</p>" +
				"<br>" +	
				"<p>Press any key to begin the trial session.</p>",
      post_trial_gap: 2000
    };
	...
	var debrief_block = {
		...
		var deviation_p = Math.round(sd4*100)/100;
			...
			return "<p>Congratulations, you have finished the trial session!</p>"+
					...
					"<p> Your accuracy was "+accuracy_p+"%.</p>"+
					"<p>You missed "+incorrect_go_p+" of the numbers (1, 2, 4, 5, 6, 7, 8, 9) and incorrectly reacted  "+incorrect_no_go_p+"x  to number 3.</p>"+
