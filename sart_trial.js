...
/* TRIALS */
	...
	var test_stimuli = [
	  { stimulus:  '<img src="https://simonhanzal.github.io/fatigue/fixation_72.bmp"><br><p style="font-size:64px;"></p><br><p style="font-size:64px;"> 0</p>', data: { test_part: 'test', correct_response: 'Space'} },
	  { stimulus: '<img src="https://simonhanzal.github.io/fatigue/fixation_72.bmp"><br><p style="font-size:64px;"></p><br><p style="font-size:64px;"> 1</p>', data: { test_part: 'test', correct_response: 'Space'} },
	  { stimulus: '<img src="https://simonhanzal.github.io/fatigue/fixation_72.bmp"><br><p style="font-size:64px;"></p><br><p style="font-size:64px;"> 2</p>', data: { test_part: 'test', correct_response: 'Space'} },
	  { stimulus: '<img src="https://simonhanzal.github.io/fatigue/fixation_72.bmp"><br><p style="font-size:64px;"></p><br><p style="font-size:64px;"> 3</p>', data: { test_part: 'test', correct_response: 'None'}  },
	  { stimulus: '<img src="https://simonhanzal.github.io/fatigue/fixation_72.bmp"><br><p style="font-size:64px;"></p><br><p style="font-size:64px;"> 4</p>', data: { test_part: 'test', correct_response: 'Space'} },
	  { stimulus: '<img src="https://simonhanzal.github.io/fatigue/fixation_72.bmp"><br><p style="font-size:64px;"></p><br><p style="font-size:64px;"> 5</p>', data: { test_part: 'test', correct_response: 'Space'} },
	  { stimulus: '<img src="https://simonhanzal.github.io/fatigue/fixation_72.bmp"><br><p style="font-size:64px;"></p><br><p style="font-size:64px;"> 6</p>', data: { test_part: 'test', correct_response: 'None'}  },
	  { stimulus: '<img src="https://simonhanzal.github.io/fatigue/fixation_72.bmp"><br><p style="font-size:64px;"></p><br><p style="font-size:64px;"> 7</p>', data: { test_part: 'test', correct_response: 'Space'} },
	  { stimulus: '<img src="https://simonhanzal.github.io/fatigue/fixation_72.bmp"><br><p style="font-size:64px;"></p><br><p style="font-size:64px;"> 8</p>', data: { test_part: 'test', correct_response: 'Space'} },
	  { stimulus: '<img src="https://simonhanzal.github.io/fatigue/fixation_72.bmp"><br><p style="font-size:64px;"></p><br><p style="font-size:64px;"> 9</p>', data: { test_part: 'test', correct_response: 'Space'} }
    ];
    ...
    var test = {
	  ...
	  on_finish: function(data){
		...
		data.three = data.stimulus == '<img src="https://simonhanzal.github.io/fatigue/fixation_72.bmp"><br><p style="font-size:64px;"></p><br><p style="font-size:64px;"> 3</p>' || data.stimulus == '<img src="https://simonhanzal.github.io/fatigue/fixation_72.bmp"><br><p style="font-size:64px;"></p><br><p style="font-size:64px;"> 6</p>';
		if(data.correct == true){
			data.type = 1;
		} else {
			data.type = 0;
			};
		if(data.stimulus == '<img src="https://simonhanzal.github.io/fatigue/fixation_72.bmp"><br><p style="font-size:64px;"></p><br><p style="font-size:64px;"> 3</p>' || data.stimulus == '<img src="https://simonhanzal.github.io/fatigue/fixation_72.bmp"><br><p style="font-size:64px;"></p><br><p style="font-size:64px;"> 6</p>'){
			data.go = 3;
		} else {
			data.go = 2;
			}
