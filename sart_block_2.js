	...
	var welcome = {
      ...
      stimulus: '<div style = "font-size:22px;">This is the second half of the experiment. Press any key to continue.</div>'
    };
	...
	var instructions = {
      ...
      stimulus: '<div style = "font-size:22px;"><strong>Reminder:</strong></div>' +
				...
				"<br>" +
				'<div style = "font-size:19px;">Make sure the experiment is still in an active window.</div>'+
				"<br>" +	
