	...
	var welcome = {
      ...
      stimulus: "You are now going to start the experiment. Press any key to continue."
    };
	...
	var instructions = {
      ...
      stimulus: "<p>Reminder:</p>" +
				...
				"<p>Try to balance speed and accuracy in your responses. If the task seems difficult, do not worry, that is a part of the experiment.</p>" +
				"<br>" +	
...
//	  { stimulus: '<div style="font-size:64px;">3</div>', data: { test_part: 'test', correct_response: 'None', font_size: '64'   } },
	...
	var debrief_block = {
		...
		var deviation_1 = Math.round(sd4*100)/100;
			...
			return "<p>Congratulations, you are now half-way through the experiment.</p>"+
				   "<p>Do not worry if you think you did not do all the trials correctly, this is all a part of the process.</p>"+
				   "<p>You can have a short break if you wish.</p>"+
				   "<p>Press any key to continue to the second part of the experiment.</p>";
		}
	};
